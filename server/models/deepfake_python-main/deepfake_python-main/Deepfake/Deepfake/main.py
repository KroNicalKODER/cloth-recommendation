...
width = 640
height = 480
image_path = "deepfake_python-main\Deepfake\Deepfake\model.jpg"  # Replace with your image path
image = cv2.imread(image_path)

# Set video parameters
video_path = "output_video.avi"  # Output video file name
frame_rate = 30  # Frames per second
duration = 5  # Duration of the video in seconds
frame_size = (image.shape[1], image.shape[0])  # Frame size based on the image
...
# Write the image to the video file for the calculated number of frames
for _ in range(total_frames):
    video_writer.write(image)

# Release the video writer to save the video file
...
image = cv2.imread("deepfake_python-main\Deepfake\Deepfake\mallu1.jpg")
